...
if [ ! -d "/tmp/hadoop/dfs/name" ]; then
    $HADOOP_HOME/bin/hdfs namenode -format -force && echo "OK : HDFS namenode format operation finished successfully !"
fi
